                    ...
                    <div className='guide-content-max'>
                        ...
                        <div className='guide-class'>
                            ...
                            <div className='guide-class-desc'>
                                ...
                                <p>창 계열 직업들이 전반적으로 강해지고 할만한 트리가 되기는 했으나, 창계열은 결국 달리아를 써야 제 성능이 나오고</p>
                                <p>일기당천을 쓸 수 없는 한창은 가치가 많이 떨어지죠. 못 할 트리는 물론 아니지만 굳이? 라는 생각이 드는게 사실이에요.</p>
                                <p>마신을 쓰는 경우에도 그럭저럭 딜이 괜찮게 뽑힙니다. 하지만 자벨린과 투망발사장치 4레벨을 스왑해도 1티어의 딜은 따라가진 못할거에요.</p>
                                <h1 class='deepblue'>스킬 트리</h1>
